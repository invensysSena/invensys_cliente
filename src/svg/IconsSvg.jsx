...
export const svgUserEnterpreses = () => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
...
export const svgName = () => {
  return (
    ...
    >
      ...
      <path fill="#ccc" d="M0 0h48v48H0z" mask="url(#ipSEditName0)" />
    </svg>
  );
};
