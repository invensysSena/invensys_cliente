...
export const Slide = () => {
  ...
  return (
    <div className="flex relative  justify-center  items-center h-96 max-w-7xl mx-auto lg:mt-36">
      <button
        className=" text-gray-800 rounded-full px-5 py-3   bg-gray-200 inline-block"
        onClick={prevImagen}
      >
      ...
      <div className="div hidden">
        {imagenActaul === 0 ? (
          <p
            className="text-2xl font-bold text-cyan-900  animate__animated animate__fadeInUp
                    absolute left-[30rem] w-80 bottom-10 tansp text-center"
          >
            Con nuestra pasion y voluntad te brindamos el mejor servicio
          </p>
        ) : null}
        {imagenActaul === 1 ? (
          <p
            className="text-2xl font-bold text-cyan-900 animate__animated animate__fadeInUp
                    absolute left-[30rem] w-80 bottom-10 tansp text-center"
          >
            Con nuestro esfuerzo seguiremos aplicando funcionalidades y mas
            herramientas que te ayuden en tu trabajo diario
          </p>
        ) : null}
        {imagenActaul === 2 ? (
          <p
            className="text-2xl font-bold text-cyan-900 animate__animated animate__fadeInUp
                    absolute left-[30rem] w-80 bottom-10 tansp text-center"
          >
            con nuestro crecimiento seguiremos aportando mejoras a stored
          </p>
        ) : null}
        {imagenActaul === 3 ? (
          <p
            className="text-2xl font-bold text-cyan-900 animate__animated animate__fadeInUp
                    absolute left-[30rem] w-80 bottom-10 tansp text-center"
          >
            Nos importa tú, te brindamos un diseño amigable para que sea comodo
            al navegar
          </p>
        ) : null}
        {imagenActaul === 4 ? (
          <p
            className="text-2xl font-bold text-cyan-900 animate__animated animate__fadeInUp
                    absolute left-[30rem] w-80 bottom-10 tansp text-center"
          >
            Trabajaremos para tener nuevas inovaciones y seguir creciento.
          </p>
        ) : null}
      </div>
    </div>
