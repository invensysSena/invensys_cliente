      ...
      <div className="w-[450px] flex flex-col">
        ...
        <div className="bg-white dark:bg-[#37415197] dark:border-[#d1d1d1a0] p-2 rounded border shadow-md ">
          <div className="py-4 px-6 lg:px-8 text-left">
            <h3 className="text-2xl text-gray-900 font-semibold dark:text-white ">
                ...
                >
                  <div className="w-full currentPassword">
                    <Field
                      ...
                      className="w-full block outline-none bg-white text-black  dark:bg-[#374151] dark:text-white"
                      autoComplete="on"
                    />
                  </div>
