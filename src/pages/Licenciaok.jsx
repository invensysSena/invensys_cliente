...
export const Licenciaok = () => {
  ...
  useEffect(() => {
    (async () => {
      ...
      const responseAll = await serviceUsers.getDataAll({n:1});
          ...
          <div className="flex-grow container mx-auto sm:px-4 pt-6 pb-8">
            <div className="effect_blure border-t dark:bg-[#37415197] dark:text-white dark:border-[#777777]  border-b sm:border-l sm:border-r sm:rounded shadow mb-6">
              ...
              <div className="flex flex-col xl:flex-row ">
                <div className="w-full border-b xl:border-none lg:w-full  xl:w-1/3 text-center py-8">
                ...
                <div className="w-full  lg:w-full  xl:w-1/3 text-center py-8">
                  <div className="border-r">
                    <div className="text-grey-darker mb-2">
                ...
                <div className="w-full  lg:w-full  xl:w-1/3 text-center py-8">
                  <div>
                    <div className="text-grey-darker mb-2">
                      ...
                      <span className="text-4xl lg:text-5xl border-b xl:border-none">
            ...
            <div className="flex flex-wrap -mx-4">
              <div className="w-[320px] md:w-full mb-6 lg:mb-0 lg:w-1/2 px-4 flex flex-col">
                <div className="flex-grow flex flex-col dark:bg-[#37415197] dark:text-white dark:border-[#777777] effect_blure border-t border-b sm:rounded sm:border shadow overflow-hidden">
                  ...
                  <div
                    className="
                  flex-grow flex-col flex md:flex-row px-6 py-6 text-grey-darker items-center border-b -mx-4"
                  >
                    <div className="w-2/5 xl:w-1/4 px-4 flex flex-col items-center">
                    ...
                    <div className=" md:flex lg:hidden xl:flex w-1/4 px-4 items-center">
                      <div className="bg-orange h-2 rounded-full flex-grow mr-2"></div>
                      {dataLicence.length > 0 ? dataLicence[0].estado : 0}
                    </div>
                  </div>
                  <div className="flex-grow flex-col md:flex-row flex px-6 py-6 text-grey-darker items-center border-b -mx-4">
                    <div className="w-2/5 xl:w-1/4 px-4 flex items-center">
                      ...
                      <span className="text-lg">Acción</span>
                    </div>
                    ...
                    <div className="flex w-3/5 md:w/12">
                      <div className="w-1/2 px-4">
                        <div className="text-right">Key cliente</div>
                      </div>
                      <div className="w-1/2 px-4">
                  ...
                  <div>
                    <div className="text-center px-6 py-4">
                      <div className="py-8">
                        ...
                        <div>
                          <span className=" rounded px-6 py-1 flex justify-center">
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              width="128"
                              height="128"
